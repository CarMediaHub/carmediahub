...
function inspectReleaseArtifacts(bundleRoot) {
  ...
  visit("dist");
  visit("public");
  for (const relative of ["package.json", "config/components.json", "config/components.schema.json", "config/component-release.schema.json", "config/native-install-plan.schema.json", "config/core.schema.json", "config/core.example.json"]) visit(relative);
...
export function validateNativeBundle(bundleRoot, options = {}) {
  ...
  const required = ["dist/cli.js", "public/admin/index.html", "scripts/upgrade-preflight.mjs", "scripts/native-install-plan.mjs", "scripts/native-install-actions.mjs", "scripts/native-windows-service.mjs", "scripts/native-linux-service.mjs", "scripts/validate-native-bundle.mjs", "config/components.json", "config/components.schema.json", "config/component-release.schema.json", "config/native-install-plan.schema.json", "config/core.schema.json", "config/core.example.json", "package.json", "node_modules/fastify/package.json", "node_modules/@fastify/cookie/package.json", "node_modules/pg/package.json", "node_modules/@carmediahub/sdk/package.json", "node_modules/@carmediahub/sdk/dist/index.js"];
