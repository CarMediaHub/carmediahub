...
export function createNativeBundle(sourceRoot, outputRoot) {
  ...
  const files = [
    "dist", "public", "scripts/upgrade-preflight.mjs", "scripts/native-install-plan.mjs", "scripts/native-windows-service.mjs", "scripts/native-linux-service.mjs", "scripts/validate-native-bundle.mjs", "config/components.json", "config/components.schema.json",
