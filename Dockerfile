...
COPY carmediahub/config/components.json carmediahub/config/components.schema.json carmediahub/config/core.example.json ./carmediahub/config/
...
COPY --from=build /workspace/carmediahub/config/components.json /workspace/carmediahub/config/components.schema.json /workspace/carmediahub/config/core.example.json ./config/
