...
const catalog: ComponentCatalogItem[] = [
  { id: "chromium", version: "1.0.0", provides: ["browser-engine"], platforms: ["linux"], status: "installed", executable: "chromium/1.0.0/chromium" },
  { id: "other", version: "1.0.0", provides: ["browser-engine"], platforms: ["linux"], status: "installed", executable: "other/1.0.0/other" }
];
