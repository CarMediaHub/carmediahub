...
type Installation = { id: string; packageId: string; packageVersion: string; runtime: string; status: "installed" | "disabled"; createdAt: string; capabilities?: string[]; declaredCapabilities?: string[]; worker?: { state: "stopped" | "starting" | "running" | "backoff" | "disabled" | "failed"; attempts: number; lastError?: string } };
